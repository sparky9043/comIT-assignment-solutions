...
urlpatterns = [
    ...
    path(
        "yearly/<int:pk>/edit/", views.YearlyUpdateView.as_view(), name="yearly-update"
    ),
    path(
        "yearly/<int:pk>/delete/",
        views.YearlyDeleteView.as_view(),
        name="yearly-delete",
    ),
    # ── Monthly CRUD ──────────────────────────────────────────────────────────
    ...
    path(
        "monthly/<int:pk>/edit/",
        views.MonthlyUpdateView.as_view(),
        name="monthly-update",
    ),
    path(
        "monthly/<int:pk>/delete/",
        views.MonthlyDeleteView.as_view(),
        name="monthly-delete",
    ),
    # ── Analysis ──────────────────────────────────────────────────────────────
    ...
    path(
        "download/yearly-csv/",
        views.DownloadYearlyCSVView.as_view(),
        name="dl-yearly-csv",
    ),
    path(
        "download/monthly-csv/",
        views.DownloadMonthlyCSVView.as_view(),
        name="dl-monthly-csv",
    ),
    path(
        "download/clinic-chart/",
        views.DownloadClinicChartView.as_view(),
        name="dl-clinic-chart",
    ),
    path(
        "download/monthly-chart/",
        views.DownloadMonthlyChartView.as_view(),
        name="dl-monthly-chart",
    ),
    path(
        "download/bootstrap-chart/",
        views.DownloadBootstrapChartView.as_view(),
        name="dl-bootstrap-chart",
    ),
]
